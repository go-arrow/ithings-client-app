  ...
  <div>
    <t-card :bordered="false">
      <div class="flex justify-between">
        <h1 class="text-xl font-bold mb-4">数据单位</h1>
        <t-button>新建单位</t-button>
      </div>
...
for (let i = 0; i < total; i++) {
  data.push({
    id: i,
    name: ['伏特每米 / V/m', '千伏 / kV', '兆帕 / Mpa', '流明 / lm'][i % 4],
    createAt: ['2022-01-12', '2023-11-22', '2022-08-07', '2023-04-02'][i % 4],
    updateAt: ['2023-08-26', '2022-11-02', '2022-07-02', '2022-06-01'][i % 4],
  })
}
</script>
